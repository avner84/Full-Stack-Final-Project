...
const RegisterForm = () => {
    ...
    useEffect(() => {
        ...
        console.log('resultFirstName :', result);
    ...
    useEffect(() => {
        ...
        console.log('resultLastName :', result);
        ...
        <>
            ...
            <form onSubmit={hundlesubmit}>
                ...
                <div className='fogate_pass_wrap'>
                    <p>יש לך כבר חשבון? <Link >לחץ כאן</Link></p>
                </div>
